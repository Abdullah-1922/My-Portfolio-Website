...
import UsedSkillsTag from '../Utils/UsedSkillsTag';
  ...
  return (
    <Container>
      <div id='project' className='pb-20'>
        <div>
          <h1 className='text-5xl pb-6 lg:text-7xl font-bold text-gray-300'>
            MY PROJECTS
          </h1>
        </div>
            ...
            <div className='mx-auto max-w-[1300px] px-4 py-4 sm:px-4 sm:py-5  lg:py-8'>
              <div className='grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16'>
                <div className='relative  h-72 overflow-hidden rounded-lg sm:h-96 lg:order-last lg:h-full'>
                  <img
                    alt='Project-1 Img'
                    src='https://i.ibb.co/tmdDddH/Screenshot-2024-02-01-215313.png'
                    className='absolute inset-0 h-full w-full '
                  />
                </div>

                <div className='lg:py-24'>
                  <h2 className='md:text-5xl  text-black  font-bold text-4xl'>
                    MAPMYFITNESS
                  </h2> 
                  <p className='text-3xl pt-1   text-black font-semibold'>
                    An online fitness platform
                  </p>

                  <p className='mt-4  text-black  lg:text-lg pb-5'>
                    A full-stack web application where users can create their
                    own workout plans and share them with others. It has a fully
                    functional admin panel where the admin can control the whole
                    website.
                  </p>
                  <div>
                    <p className='text-xl pb-5   text-black  font-semibold '>
                      Main Technologies :
                    </p>
                    <div className='flex flex-wrap font-serif gap-2'>
                      <UsedSkillsTag data={'React JS'}></UsedSkillsTag>
                      <UsedSkillsTag data={'Node JS'}></UsedSkillsTag>
                      <UsedSkillsTag data={'MongoDB'}></UsedSkillsTag>
                      <UsedSkillsTag data={'Firebase'}></UsedSkillsTag>
                      <UsedSkillsTag data={'Stripe'}></UsedSkillsTag>
                      <UsedSkillsTag data={'Express'}></UsedSkillsTag>
                      <UsedSkillsTag data={'Tailwind CSS'}></UsedSkillsTag>
                    </div>
                  </div>
                  <div className='flex  pt-10 text-lg font-bold gap-10'>
                    <a target='_blank' rel='noopener noreferrer' href="https://github.com/Abdullah-1922/MAPMYFITNESS-Client">
                      <button
                      className='flex items-center rounded border border-current px-8 text-sm font-medium text-indigo-600 transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:text-indigo-500'
                     >
                      GitHub
                      <svg
                    ...
                    <a
                      href='https://mapmyfitness-f994d.firebaseapp.com/'
                      target='_blank'
            ...
            <div className='mx-auto max-w-[1300px] px-4 py-4 sm:px-4 sm:py-5  lg:py-8'>
              <div className='grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16'>
                <div className='relative  h-72 overflow-hidden rounded-lg sm:h-96 lg:order-last lg:h-full'>
                  <img
                    alt='Project-2 Img'
                    src='https://i.ibb.co/LCXwLSc/Screenshot-2024-02-02-203404.png'
                    className='absolute inset-0 h-full w-full '
                  />
                </div>
                ...
                <div className='lg:py-24'>
                  ...
                  <p className='text-3xl  text-black  pt-1 font-semibold'>
                    A job searching platform
                  </p>

                  <p className='mt-4 lg:text-lg pb-5  text-black '>
                   A website where user can search for jobs and apply for them. Also users can post jobs. 
                  </p>
                  <div>
                    <p className='text-xl pb-5  text-black  font-semibold '>
                      Main Technologies :
                  ...
                  <div className='flex  pt-10 text-lg font-bold gap-10'>
                    <a target='_blank' rel='noopener noreferrer' href="https://github.com/Abdullah-1922/NextJob-client/tree/main"><button
                      className='flex items-center rounded border border-current px-8 text-sm font-medium text-indigo-600 transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:text-indigo-500'
                      href='/download'>
                      GitHub
                      <svg
                    ...
                    <a
                      href='https://assignment-11-3e59d.firebaseapp.com/'
                      target='_blank'
                      rel='noopener noreferrer'>
                      <button
                        className='flex items-center rounded border border-current px-8  text-sm font-medium text-indigo-600 transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:text-indigo-500'
